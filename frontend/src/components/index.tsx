...
import { Badge as ShadcnBadge } from '@/components/badge'
import { Button as ShadcnButton } from '@/components/button'
import { Card as ShadcnCard, CardContent, CardHeader, CardTitle } from '@/components/card'
...
export function Card({
  ...
  return (
    <ShadcnCard id={id} className={className}>
      {title && (
...
export function Button({
  ...
  return (
    <ShadcnButton variant={variant} size="sm" type={type} onClick={onClick} disabled={disabled} className={className} asChild={asChild}>
      {children}
    </ShadcnButton>
  )
}
