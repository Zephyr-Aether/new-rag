...
const MergedPlanes = forwardRef<THREE.Mesh | null, { material: any; width: number; count: number; height: number }>(({ material, width, count, height }, ref) => {
...
const PlaneNoise = forwardRef<THREE.Mesh | null, { material: any; width: number; count: number; height: number }>((props, ref) => (
