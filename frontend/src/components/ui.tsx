...
function tone(status: string): Tone {
  ...
  if (['ACTIVE', 'COMPLETED', 'SUCCEEDED', 'PASSED', 'PASS', 'OK', 'READY', 'ALLOWED'].includes(s)) return 'success'
  if (['GRAY', 'RUNNING', 'PENDING', 'WARN', 'QUEUED', 'CREATED', 'PAUSED'].includes(s)) return 'warning'
  if (['FAILED', 'DEAD_LETTER', 'REJECTED', 'FAIL', 'DOWN', 'DENIED', 'NOT_FOUND', 'UNKNOWN'].includes(s))
    return 'destructive'
