...
const RETRIEVAL_PARAM_DESC: [string, string][] = [
...
export default function Knowledge() {
  ...
  return (
    <div className="grid" style={{ gap: 18 }}>
      ...
      <PageHeader
        title="知识库"
        desc="先选库，再导入，再检索；知识库参数会直接影响对话里的引用质量和召回命中。"
        actions={
          <>
      ...
      <div className="knowledge-panels grid cols-3">
        <div>
        ...
        <div>
          <Card title="检索" className="knowledge-card">
            <div className="row">
              <input
                value={query}
